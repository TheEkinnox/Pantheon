...
void main()
{
	...
	vs_out.FragPos = (pth_modelMat * vec4(_pos, 1.0)).xyz;
	vs_out.Normal = (pth_normalMat * vec4(_normal, 0)).xyz;
...
#include "shaders/Core.fragh"
#include "shaders/BlinnPhong.glslh"
#include "shaders/Light.glslh"
...
void main()
{
	...
	g_viewDir = normalize(pth_viewPos - fs_in.FragPos);
