...
namespace PantheonTest
{
    ...
    static_assert(std::is_same_v<PantheonCore::Utility::SmallestIntT<float>, int32_t>);
    ...
    static_assert(std::is_same_v<PantheonCore::Utility::SmallestIntT<double>, int64_t>);
    static_assert(std::is_same_v<PantheonCore::Utility::SmallestIntT<long double>, int64_t>);
    ...
    static_assert(std::is_same_v<PantheonCore::Utility::SmallestUIntT<float>, uint32_t>);
    ...
    static_assert(std::is_same_v<PantheonCore::Utility::SmallestUIntT<double>, uint64_t>);
    static_assert(std::is_same_v<PantheonCore::Utility::SmallestUIntT<long double>, uint64_t>);
}
